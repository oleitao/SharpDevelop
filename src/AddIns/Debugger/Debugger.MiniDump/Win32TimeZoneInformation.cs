using Debugger.MiniDump.Native;
using System;
...
namespace Debugger.MiniDump
{
    ...
    public sealed class Win32TimeZoneInformation
    {
        ...
        /// <summary>
        /// A <see cref="Debugger.MiniDump.Win32SystemTime"/> that contains a date and local time when the transition from daylight saving time to standard time occurs on this operating system. 
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// A <see cref="Debugger.MiniDump.Win32SystemTime"/> that contains a date and local time when the transition from standard time to daylight saving time occurs on this operating system. 
        /// </summary>
        /// <remarks>
        /// See https://msdn.microsoft.com/en-us/library/windows/desktop/ms725481%28v=vs.85%29.aspx?f=255&MSPPError=-2147217396 for details on how to decode this value.
        /// </remarks>
