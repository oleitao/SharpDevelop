...
namespace Debugger.AddIn.Pads.DiagnosisPad.Dump.Explorer.Views
{
	...
	public partial class SystemMemoryInfoView : BaseViewControl
    {
		...
		/// <summary>
		/// The LVG system memory information
		/// </summary>
		private const int LVG_SYSTEM_MEMORY_INFO = 0;
		/// <summary>
		/// The LVG system basic information
		/// </summary>
		private const int LVG_SYSTEM_BASIC_INFO = 1;
		/// <summary>
		/// The LVG system file cache information
		/// </summary>
		private const int LVG_SYSTEM_FILE_CACHE_INFO = 2;
		/// <summary>
		/// The LVG system basic performance information
		/// </summary>
		private const int LVG_SYSTEM_BASIC_PERFORMANCE_INFO = 3;
		/// <summary>
		/// The LVG system performance information
		/// </summary>
		private const int LVG_SYSTEM_PERFORMANCE_INFO = 4;

		/// <summary>
		/// Initializes a new instance of the <see cref="SystemMemoryInfoView"/> class.
		/// </summary>
		...
		/// Initializes a new instance of the <see cref="SystemMemoryInfoView"/> class.
		/// </summary>
		/// <param name="systemMemoryInfo">The system memory information.</param>
