...
{
	/// <summary>
	/// MinidumpListView controler view
	/// </summary>
	/// <seealso cref="Debugger.AddIn.Pads.DiagnosisPad.Dump.Explorer.Controls.ListViewEx" />
	class MinidumpListView : ListViewEx
    {
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="MinidumpListView"/> class.
		/// </summary>
		...
		/// <summary>
		/// Handles the Closing event of the FitlerMenu control.
		/// </summary>
		...
		/// <summary>
		/// Handles the Click event of the FilterMenuItem control.
		/// </summary>
		/// <param name="sender">The source of the event.</param>
		...
		/// <summary>
		/// Displays the column header dropdown.
		/// </summary>
