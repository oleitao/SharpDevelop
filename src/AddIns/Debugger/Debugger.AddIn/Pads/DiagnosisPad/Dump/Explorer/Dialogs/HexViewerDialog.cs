...
namespace Debugger.AddIn.Pads.DiagnosisPad.Dump.Explorer.Dialogs
{
    partial class HexViewerDialog : Form
    {
        ...
        public HexViewerDialog(byte[] data)
            : this()
        {
            this.Text = $"Displaying {Debugger.MiniDump.Formatters.FormatAsSizeString((uint)data.Length)} ({data.Length} bytes)";
